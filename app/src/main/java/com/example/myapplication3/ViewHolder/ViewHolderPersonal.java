...
public class ViewHolderPersonal extends RecyclerView.ViewHolder {
    ...
    public void setearDatos(Context context, String nombres, String apellidos, String cumpleanos, String telefono, String area, String foto) {
        TextView tvNombre = mView.findViewById(R.id.tvNombrePersonalP);
        TextView tvArea = mView.findViewById(R.id.tvAreaPersonalP);
        TextView tvCumple = mView.findViewById(R.id.tvCumplePersonalP);
        ...
        tvArea.setText(area);
        tvCumple.setText("Cumpleaños: " + cumpleanos);
